...
export type IconName =
  | 'List' | 'FileText' | 'Languages' | 'Users' | 'Settings' | 'Settings2'
  | 'Circle' | 'Sparkles' | 'Eye' | 'EyeOff' | 'Bell' | 'Search'
  | 'UserPlus' | 'Plus' | 'Check' | 'CheckCheck' | 'ChevronDown' | 'ChevronRight'
  | 'ChevronsUpDown' | 'ArrowRight' | 'ArrowRightLeft' | 'ArrowUpRight' | 'X'
  | 'WandSparkles' | 'Flag' | 'SendHorizontal' | 'MoreHorizontal'
  | 'FileUp' | 'FileDown' | 'Upload' | 'Download' | 'Tag' | 'CalendarClock'
  | 'Calendar' | 'KeyRound' | 'GitBranch' | 'Github' | 'Terminal' | 'Webhook'
  | 'MessageSquare' | 'Copy' | 'Trash2' | 'PencilLine' | 'Variable'
  | 'FolderGit2' | 'LayoutGrid' | 'Globe' | 'CircleDashed' | 'TriangleAlert';
...
const P: Record<IconName, string> = {
  ...
  FolderGit2: '<path d="M9 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v3"/><circle cx="13" cy="12" r="2"/><path d="M18 19c-2.8 0-5-2.2-5-5v8"/><circle cx="20" cy="19" r="2"/>',
  LayoutGrid: '<rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/>',
  TriangleAlert: '<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 20h16a2 2 0 0 0 1.73-2"/><path d="M12 9v4"/><path d="M12 17h.01"/>',
};
...
export class Icon {
  ...
  protected readonly markup = computed(() =>
    this.sanitizer.bypassSecurityTrustHtml(P[this.name()] ?? ''),
  );
}
